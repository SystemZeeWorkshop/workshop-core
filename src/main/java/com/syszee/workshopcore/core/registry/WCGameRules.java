...
public final class WCGameRules {
	...
	public static final GameRules.Key<GameRules.BooleanValue> RULE_SHOW_INFO_POPUPS = GameRules.register(WorkshopCore.MOD_ID + ".showInfoPopups", GameRules.Category.MOBS, GameRules.BooleanValue.create(false));
